...
<h1 style="text-align: left; color: grey; font-weight: bold;font-style: italic;padding-left: 35px; text-align: center;">Plane Update</h1><br>
<div class="row">
		<div class="col-sm-3">
...
?>
	...
	<form action="" method="post">
		...
		<input type="submit" name="u_plane" class="btn btn-primary" value="Update"><br>
		</form>
...
<?php
		 if(isset($_POST['u_plane']))
			...
			$first_seats = mysqli_real_escape_string($db,$_POST['first_seats']);
				$query2="UPDATE plane SET brand='$plane_brand',economy=$economy_seats,business=$business_seats,first=$first_seats where plane_id=$plane_id";
