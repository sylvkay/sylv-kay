...
<h1 style="text-align: left; color: grey; font-weight: bold;font-style: italic;padding-left: 35px; text-align: center;"> Delete Flight</h1><br>
<div class="row">
		<div class="col-sm-3">
...
<form action="" method="post">
	<label>Enter flight Id <input type="text" name="del_flight_id" class="form-control"></label>
...
{
	$flight_id=mysqli_real_escape_string($db,$_POST['del_flight_id']);
...
?>
 ...
 <input  type="submit" name="del_flight" class="btn btn-success" value="Delete">
		...
		<?php
		 if(isset($_POST['del_flight']))
			...
			$query2="DELETE FROM flight where flight_id=$flight_id";
