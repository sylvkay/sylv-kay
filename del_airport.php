...
?>
	<h1 style="text-align: left; color: grey;font-weight: bold;font-style: italic;padding-left: 35px;text-align: center"> Delete Airport</h1><br>
...
?>
	...
	<form action="" method="post">
		...
		<input type="submit" name="u_airport" class="btn btn-primary" value="Delete"><br>
	</form>
	...
	<?php
		 if(isset($_POST['u_airport']))
			...
			$query2="DELETE FROM airport where airport_id=$airport_id";
