...
<form action="" method="post">
    <center>
        <label>Source<input class="form-control" type="text" name="source"></label>
        ...
        <label>Way</label>
        <select class="form-control" name="way" style="width: 60%;">
          ...
          <td>Book</td>
            ...
            ?>
               <tr>
                ...
                <td><a href="user_details.php?flight_id=<?php echo $rs['flight_id']?>"><button class="btn btn-success btn-sm">Book Flight</button></a></td>              
               </tr>
            <?php
               }
            ?>
